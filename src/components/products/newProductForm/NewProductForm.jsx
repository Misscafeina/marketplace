...
import useNewProductForm from "../../../hooks/useProductForm";

const NewProductForm = () => {
  const { setLoginActive, setRegisterActive, setNewProductActive } =
    ...
    <div className="popup">
      <div className="popup-inner">
        ...
        <form onSubmit={handleSubmit(submitInfo)}>
          ...
          <input
            type="textarea"
            register={classnames({ error: errors.Description })}
            {...register("Description", { required: true, maxLength: 255 })}
          />
          <label>Categoría:</label>
          <select {...register("Category", { required: true })}>
            <option value="Music">Música</option>
            <option value="Photografyvideo">Fotografía y Vídeo</option>
            <option value="Gaming">Consolas y juegos</option>
            <option value="Computer">Ordenadores</option>
            <option value="Collector">Artículos de coleccionista</option>
          ...
          {errors.price?.type === "max" && (
            <span>El precio no puede ser inferior a 20 €</span>
          )}
          ...
          <label>País:</label>
          <select {...register("Country", { required: true })} name="pais">
